# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-07 02:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=temporal_django.db_extensions.GistIndex(fields=['effective'], name='ix_example_app_item_history_title_effective'),
        ),
        migrations.AddIndex(
            model_name='itemhistory_title',
        ...
        migrations.AddIndex(
            ...
            index=temporal_django.db_extensions.GistIndex(fields=['effective'], name='ix_example_app_item_history_number_effective'),
        ),
        migrations.AddIndex(
            model_name='itemhistory_number',
        ...
        migrations.AddIndex(
            ...
            index=temporal_django.db_extensions.GistIndex(fields=['effective'], name='ix_example_app_item_history_effective_date_effective'),
        ),
        migrations.AddIndex(
            model_name='itemhistory_effective_date',
        ...
        migrations.AlterUniqueTogether(
            name='itemclock',
            unique_together=set([('tick', 'entity'), ('entity', 'activity')]),
        ),
    ]
